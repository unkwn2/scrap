...
REPAIR_ALIASES = {
    ...
    "Замена разъема зарядки": [
        ...
        "замена ниж. шлейфа", "замена шлейфа с разъемом зарядки",
    ],
    "Замена стекла": [
    ...
    "Замена разговорного микрофона": [
        "замена разговорного микрофона", "замена микрофона",
        "замена микрофона разговорного",
    ],
    "Замена слухового динамика": [
        "замена слухового динамика",
        "замена динамика верхнего",
    ],
    "Замена полифонического динамика": [
        "замена полифонического динамика",
        "замена динамика нижнего",
    ],
    "Замена вентилятора": [
        "замена вентилятора",
    ],
